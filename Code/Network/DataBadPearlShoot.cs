...
namespace Celeste.Mod.HeartWars {
    ...
    public class DataBadPearlShoot : DataType<DataBadPearlShoot> {
        static DataBadPearlShoot() => DataID = $"{HeartWarsModule.Name}_DataBadPearlShoot_{HeartWarsModule.ProtocolVersion}";
